...
declare class Pipelines extends BaseService {
    ...
    delete(projectId: ProjectId, pipelineId: PipelineId, options?: Sudo): Promise<object>;
    ...
    allVariables(projectId: ProjectId, pipelineId: PipelineId, options?: PaginatedRequestOptions): Promise<import("../infrastructure").GetResponse>;
}
